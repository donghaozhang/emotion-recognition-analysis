#!/usr/bin/env python3
"""
GPT-5 Emotion Recognition Script

This script uses the GPT-5 model via OpenRouter API to analyze emotions
...
class GPT5EmotionAnalyzer:
    """Emotion analyzer using GPT-5 model via OpenRouter"""
    ...
    def analyze_emotion(self, image_path: Path) -> Dict:
        """Analyze emotion in a single image using GPT-5"""
...
Reply with just the emotion word."""
    ...
    def analyze_batch(self, image_folder: Path, num_images: int = None) -> List[Dict]:
        ...
        """
        print(f"🚀 Starting GPT-5 emotion analysis")
    ...
    def save_results(self, results: List[Dict], output_file: str = "gpt5_emotion_results.json"):
...
def main():
    """Main function to run GPT-5 emotion analysis"""
    ...
    OUTPUT_FILE = "gpt5_emotion_results.json"
    
    print("🎭 GPT-5 Emotion Recognition Analyzer")
    print("="*60)
    ...
    try:
        # Initialize analyzer
        analyzer = GPT5EmotionAnalyzer(api_key)
